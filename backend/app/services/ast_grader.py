...
from app.services.grading.constants import ASTGradingResult as GradingResult  # noqa: F401
...
from app.services.grading.grader import (
    DSALightningGrader,  # noqa: F401
...
from app.services.grading.scorer import (
    DSAScorer,  # noqa: F401
    score_complexity,
)
from app.services.grading.test_runner import (
    run_dynamic_tests,  # noqa: F401
    score_static_tests,
)
...
def safe_grade_code(
    ...
    try:
        ...
        if student_name or student_id:
            student_name, student_id = validate_student_info(student_name, student_id)

        # Step 3: Grade the code using lightning grader
        result = lightning_grader.grade_file_ultra_fast(
            code=sanitized_code, filename=filename, topic=topic or ""
        )
