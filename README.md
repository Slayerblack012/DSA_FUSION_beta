...
DSA Fusion Final is an autonomous, scalable grading platform for Python Data Structures and Algorithms (DSA) assignments. It combines AST static analysis, sandboxed dynamic execution, and an **AI-Agent Professor** module to provide instantaneous, human-like feedback to students.
